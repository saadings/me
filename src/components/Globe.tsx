...
export function GlobeDemo() {
  ...
  return (
    <div className="relative flex h-screen w-full flex-row items-center justify-center bg-white py-10 dark:bg-black md:h-auto">
      <div className="relative mx-auto h-full w-full max-w-7xl overflow-hidden px-4 md:h-[40rem]">
        ...
        >
          <div className="flex justify-center">
            <h2 className="text-center text-xl font-bold text-black dark:text-gray-200 md:text-4xl">
              Welcome to the World of Saadings!
            </h2>
          </div>
