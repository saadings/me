  ...
  return (
    <div>
      <button className="relative inline-flex h-12 w-[10rem] overflow-hidden rounded-full p-0.5 focus:outline-none">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 text-lg font-semibold text-white backdrop-blur-3xl">
          {order}
        </span>
      </button>
    </div>
